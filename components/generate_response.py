...
def generate_fact(title,domain):
    ...
    The script should be under [75] words. Begin with a hook that grabs attention and is easy to understand for a broad audience. do not use any
    symbols as this response will be given to a tts engine.
    Keep technical jargon to a minimum, and end with a subtle invitation for viewers to learn more,
    encouraging them to check the description for detailed explaination."""
